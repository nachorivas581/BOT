...
URL=https://github.com/nachorivas581/BOT/blob/main/BOT_ADM/BOT_VPSMOD/admvps.sh
...
botcommands=(
	...
	["/onudp"]="upudp"
        ["/offudp"]="offudp"
	["/onbad"]="wget -O /bin/badvpn-udpgw https://www.dropbox.com/s/nxf5s1lffmbikwq/badvpn-udpgw &>/dev/null; chmod 777 /bin/badvpn-udpgw; screen -dmS screen /bin/badvpn-udpgw --listen-addr 127.0.0.1:7300 --max-clients 1000 --max-connections-for-client 10 ; echo 'BADVPN ACTIVADO'"
        ["/offbad"]="pkill badvpn ;echo 'BADVPN DESACTIVADO'"
        ["/onpsi"]="on"
        ["/datpsi"]="config"
        ["/ssh"]="crear"
